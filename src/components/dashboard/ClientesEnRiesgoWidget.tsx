...
import { AlertTriangle, Phone, Mail, Clock, TrendingDown, RefreshCw, ExternalLink } from 'lucide-react'
...
export function ClientesEnRiesgoWidget() {
    ...
    async function loadClientes() {
        try {
            setLoading(true)
            const response = await fetch('/api/ia/clientes-riesgo')
    ...
    function getRiesgoBadge(nivel: string) {
        switch (nivel) {
            ...
            case 'medio':
                return <Badge variant="default" className="bg-yellow-500">Medio</Badge>
            default:
            ...
            <Card>
                ...
                <CardContent>
                    <div className="text-center py-6 text-muted-foreground">
                        <p>🎉 ¡Excelente! No hay clientes en riesgo</p>
                        <p className="text-sm mt-1">Todos tus clientes están comprando regularmente</p>
                    </div>
                </CardContent>
            </Card>
        )
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-3 mt-2">
                                    <span className="text-xs text-muted-foreground flex items-center gap-1">
                                        ...
                                        Última compra: {formatDistanceToNow(new Date(cliente.ultimaCompra), {
                                            addSuffix: true,
                                            locale: es,
                                        })}
                                    </span>
