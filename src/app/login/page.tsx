...
export default async function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/10 via-background to-secondary/5 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
