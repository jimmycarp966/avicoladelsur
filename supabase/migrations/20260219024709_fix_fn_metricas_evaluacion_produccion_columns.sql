...
BEGIN
  ...
  v_rendimiento := jsonb_build_object(
    'ventas', (
      ...
      FROM pedidos
      WHERE usuario_vendedor = (SELECT usuario_id FROM rrhh_empleados WHERE id = p_empleado_id)
    ...
    'produccion', (
      ...
      WHERE operario_id = (SELECT usuario_id FROM rrhh_empleados WHERE id = p_empleado_id)
