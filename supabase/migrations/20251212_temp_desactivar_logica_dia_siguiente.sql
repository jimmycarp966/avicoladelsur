...
-- ===========================================
-- MIGRACIÓN TEMPORAL: Desactivar lógica de día siguiente
-- Fecha: 12/12/2025
-- Descripción: Temporalmente, todos los presupuestos se asignan a HOY sin importar la hora.
--              ⚠️ REVERTIR DESPUÉS DE LAS PRUEBAS con: 20251212_revertir_logica_dia_siguiente.sql
-- ===========================================
...
-- 2. Crear la función CON LÓGICA TEMPORAL (siempre asigna a HOY)
...
COMMENT ON FUNCTION public.fn_crear_presupuesto_desde_bot IS '⚠️ VERSIÓN TEMPORAL: Todos los presupuestos se asignan a HOY. Revertir con 20251212_revertir_logica_dia_siguiente.sql';
