...
-- Índices para sucursales.zona_id
...
-- 8. RLS para sucursales.zona_id
-- ===========================================
-- Ya existe RLS para sucursales, solo agregamos política para lectura de zona_id
CREATE POLICY "users_read_sucursal_zona" ON sucursales
    FOR SELECT
    USING (true);

-- 9. Trigger para actualizar updated_at en rutas_retiros
-- ===========================================
...
-- 10. Función para obtener zona de una sucursal
-- ===========================================
...
-- 11. Función para calcular total de arqueo
-- ===========================================
