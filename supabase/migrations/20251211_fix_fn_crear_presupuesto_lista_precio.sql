-- ===========================================
-- MIGRACIÓN: Fix función fn_crear_presupuesto_desde_bot para incluir p_lista_precio_id
-- Fecha: 11/12/2025
-- Descripción: Agregar parámetro p_lista_precio_id que fue removido en migración anterior
-- ===========================================

BEGIN;

-- Actualizar función fn_crear_presupuesto_desde_bot para incluir p_lista_precio_id
