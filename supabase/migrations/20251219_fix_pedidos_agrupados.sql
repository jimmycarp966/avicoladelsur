-- ===========================================
-- MIGRACIÓN: Fix Pedidos Agrupados
-- Fecha: 19/12/2025
-- Problema: La migración 20251216_mejora_ux_venta_mayorista.sql
--           sobrescribió fn_convertir_presupuesto_a_pedido y eliminó
--           la lógica de pedidos agrupados por turno/zona/fecha.
-- Solución: Restaurar la lógica de agrupación manteniendo las mejoras
--           de venta mayorista.
-- ===========================================
...
-- ===========================================
-- ACTUALIZAR fn_convertir_presupuesto_a_pedido
-- Combina: lógica de pedidos agrupados + venta mayorista
-- ===========================================
