...
-- ===========================================
-- MIGRACIÓN: Fix definitivo de parámetros en fn_crear_presupuesto_desde_bot
-- Fecha: 12/12/2025
-- Descripción: Eliminar TODAS las versiones previas de la función para evitar conflictos de "no único" y crear la versión correcta.
-- ===========================================
...
-- 2. Crear la función con la firma completa y correcta
